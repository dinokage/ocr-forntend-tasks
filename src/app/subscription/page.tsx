...
import image1 from '../../../public/right.png'
import image2 from '../../../public/wrong.png'
...
export default function PricingPage() {
  ...
  <div className="bg-white w-[250px] overflow-hidden p-6  rounded-tl-[80px] rounded-br-[80px]  ">
          ...
          <ul className="w-fit mx-auto flex flex-col justify-center text-gray-700 space-y-4  text-sm mt-6">
            <li className="flex gap-2"><Image src={image1} alt="check" width={18} height={18} /><span>3 Uploads</span></li>
            <li className="flex gap-2"><Image src={image2} alt="check" width={18} height={18} /><span>Edit Responses</span></li>
            <li className="flex gap-2"><Image src={image2} alt="check" width={18} height={18} /><span>Bulk Upload</span></li>
            <li className="flex gap-2"><Image src={image2} alt="check" width={18} height={18} /><span>Mobile App Support</span></li>
            <li className="flex gap-2"><Image src={image1} alt="check" width={18} height={18} /><span>Email Support</span></li>
          </ul>
        ...
        <div className="bg-white w-[250px] overflow-hidden p-6  rounded-tl-[80px] rounded-br-[80px]">
          ...
          <ul className="w-fit mx-auto flex flex-col justify-center text-gray-700 space-y-4  text-sm mt-6">
            <li className="flex gap-2"><Image src={image1} alt="check" width={18} height={18} /><span>Custom Limit</span></li>
            <li className="flex gap-2"><Image src={image1} alt="check" width={18} height={18} /><span>Edit Responses</span></li>
            <li className="flex gap-2"><Image src={image1} alt="check" width={18} height={18} /><span>Bulk Upload</span></li>
            <li className="flex gap-2"><Image src={image1} alt="check" width={18} height={18} /><span>Mobile App Support</span></li>
            <li className="flex gap-2"><Image src={image1} alt="check" width={18} height={18} /><span>Custom Limit</span></li>
            <li className="flex gap-2"><Image src={image1} alt="check" width={18} height={18} /><span>Edit Responses</span></li>
            <li className="flex gap-2"><Image src={image1} alt="check" width={18} height={18} /><span>Bulk Upload</span></li>
            <li className="flex gap-2"><Image src={image1} alt="check" width={18} height={18} /><span>Mobile App Support</span></li>
        ...
        <div className="bg-white w-[250px] overflow-hidden p-6  rounded-tl-[80px] rounded-br-[80px]">
          ...
          <ul className="w-fit mx-auto flex flex-col justify-center text-gray-700 space-y-4  text-sm mt-6">
            <li className="flex gap-2"><Image src={image1} alt="check" width={18} height={18} /><span>50 Uploads</span></li>
            <li className="flex gap-2"><Image src={image1} alt="check" width={18} height={18} /><span>Edit Responses</span></li>
            <li className="flex gap-2"><Image src={image2} alt="check" width={18} height={18} /><span>Bulk Upload</span></li>
            <li className="flex gap-2"><Image src={image2} alt="check" width={18} height={18} /><span>Mobile App Support</span></li>
            <li className="flex gap-2"><Image src={image1} alt="check" width={18} height={18} /><span>Live Chat Support</span></li>
          </ul>
